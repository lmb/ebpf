...
func TestBuild(t *testing.T) {
	...
	have, err := loadRawSpec(bytes.NewReader(buf.Bytes()), internal.NativeEndian, nil, false)
...
limitTypes:
	...
	rebuilt, err := loadRawSpec(bytes.NewReader(buf.Bytes()), binary.LittleEndian, nil, false)
